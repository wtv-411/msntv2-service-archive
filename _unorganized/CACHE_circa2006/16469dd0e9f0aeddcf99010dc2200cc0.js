...
function DoMove()
{
	...
	if (movemailframe.document.all.target.checked)
	{
		var result = ValidateInputFolderName("newfolder", "movemailframe");
...
function UpdateFolderList()
{
	...
	for (var i=0; i<folderListURL.length; i++)
	{
		...
		+ folderListURL[i] + "\"><pre class=n>" + folderListName[i] + "</pre></div>"
	}
